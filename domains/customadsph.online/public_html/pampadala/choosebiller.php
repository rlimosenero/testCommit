...
//id=table-data populate but when user type some thing action query is triggered
include 'samutsari/db.php';
$stmt = $con->prepare("SELECT `BillerDescription` FROM `pampadala_ecpay_biller`");
$stmt->execute();
