...
<head>
  ...
  <meta name="description" content="PamPadala Admin Portal">
  <meta name="author" content="Rey Limosenero">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Pam-Padala</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Pamela C. Reyes</span>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php
                          $bal = $obj->CheckBalanceResult->RemBal;
                          //setlocale(LC_MONETARY,"en_PH");
                          $fmt = new NumberFormatter( 'en_PH', NumberFormatter::CURRENCY );
echo $fmt->formatCurrency($bal, "PHP")."\n";

                          //echo money_format("%i", ltrim($bal,"USD") ) ; 
                          ?>   
                      </div>
                    </div>
                    <div class="col-auto">
              ...
              <div class="row">
                <div class="col-sm-6 mb-4">
                  <div class="card bg-primary text-white shadow">
                    <div class="card-body">
                      <a href="choosebiller.php" style="color: white">Pam</a>
                      
                      <div class="text-white-50 small">Pa-BayadBills</div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 mb-4">
                  <div class="card bg-success text-white shadow">
                    <div class="card-body">
                      Pam
                      <div class="text-white-50 small">Pa-Load</div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 mb-4">
                  <div class="card bg-info text-white shadow">
                    <div class="card-body">
                       <a href="pamcash/choosecashservice.php" style="color: white">Pam</a>
                      <div class="text-white-50 small">Pa-Cash-In</div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 mb-4">
                  <div class="card bg-warning text-white shadow">
                    <div class="card-body">
                      Pam
                      <div class="text-white-50 small">Pa-Air-Ticket</div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12 mb-4">
                  <div class="card bg-danger text-white shadow">
                    <div class="card-body">
                      Pam
                      <div class="text-white-50 small">Pa-Remit</div>
                    </div>
                  </div>
                </div>
...
<!--               <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <h4 class="small font-weight-bold">Account Setup <span class="float-right">80%</span></h4>
                  <div class="progress">
        ...
        <!-- /.container-fluid End DashBoard Page Content-->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; PamPadala 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
